...
<div class=" col-md-12 ">   <div class="form-group col-md-10 ">  
                      ...
                      <div class="col-md-9 inputGroupContainer">
                        <div style="width: 100%">
                          <textarea class="form-control" id="mytextarea" name="resume" rows="3"> {!!$projet->resume!!}
                          </textarea>
                        </div>
                      </div>
                  </div>
...
<div class=" col-md-12 ">   <div class="form-group col-md-10 ">  
                        ...
                        <div class="col-md-9 inputGroupContainer">
                      <div style="width: 100%">
                        <select name="contact[]" id="contact" class="form-control select2 " multiple="multiple" data-placeholder="Selectionnez les Membres">
                          <option>
